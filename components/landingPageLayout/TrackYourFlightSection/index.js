...
import StoreButton from "../../Common/AppButton";
  ...
  return (
    ...
    >
      <Container maxWidth="xl">
        ...
        <Grid container mt={{ md: 15, xs: 40 }} justifyContent={"center"}>
          <Grid item xs={0} lg={1.2} md={1}></Grid>
          <Grid item xs={6} lg={2.8} md={4}>
            <UserCard
              i={0}
              names="Lesli Opper"
              miles="565 089"
          ...
          <Grid item xs={0} lg={1.5} md={1}></Grid>
